          ...
          <div className="flex mt-7  flex-col gap-5 justify-evenly ">
           <div className="md:flex md:flex-row md:justify-evenly">
            ...
            <div className="md:flex md:flex-row md:flex-row-reverse md:justify-evenly">
                ...
                <img className="md:w-[50%]" src="/images/history6.jpg" alt="history" />
            </div>
            <div className="md:flex md:flex-row md:justify-evenly">
            ...
            <div className="md:flex md:flex-row md:flex-row-reverse md:justify-evenly">
                <p className="leading md:w-[40%] text-justify">
                Our journey has been marked by countless miracles and testimonies of lives transformed by the power of God&apos;s love.
                Each step forward has been guided by faith, prayer, and the tireless dedication of our founder and congregation.
                </p>
                <img className="md:w-[50%]" src="/images/history4.jpg" alt="history" />
            </div>
            <div className="md:flex md:flex-row md:justify-evenly">
                <p className="leading md:w-[40%] text-justify">
                 We have seen hearts healed, families restored, and hope rekindled in countless souls.As we continue to grow, we remain steadfast in our mission,
                ...
                <img className="md:w-[50%]" src="/images/history3.jpg" alt="history" />
             </div>
            <p></p>
          </div>
        </div>
